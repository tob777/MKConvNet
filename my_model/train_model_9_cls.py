...
def train(net, train_data, train_label, test_data, test_label, lr, weight_decay, num_epochs, batch_size, is_shuffle, lr_period, lr_decay, is_lr_decay=False):
    ...
    np.savetxt('D:/4.outcome/resnet_cnn.csv', data_outcome, delimiter=',')

label_all, label_AFO = [6, 7, 8, 3, 4, 5, 0, 1, 2], [1, 2, 3, 0]
window_size, step, num_kinds,  = 150, 150, 9
lr, num_epochs, batch_size, is_shuffle = 0.0005, 106, 128, True
weight_decay, lr_period, lr_decay, is_lr_decay = 0.001, 5, 0.9, True

net = cnet.net

data_root = 'D:/3.data/3.conv_data/3.conv_data_train_test_12'
train_data, train_label, test_data, test_label = data_processing(data_root, window_size, step, num_kinds, label_all)
